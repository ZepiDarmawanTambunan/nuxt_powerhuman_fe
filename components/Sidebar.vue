  ...
  >
    <div class="px-6 py-[50px] gap-y-[50px] flex flex-col">
      ...
      <div class="flex flex-col gap-4">
        ...
        <NuxtLink :to="{ name: 'companies-id' }" class="nav-link" exact-active-class="nav-link active">
          <img src="/assets/svgs/ic-grid.svg" alt="" />
          Overview
        </NuxtLink>
        <NuxtLink :to="{ name: 'companies-id-employees' }" class="nav-link" exact-active-class="nav-link active">
          <img src="/assets/svgs/ic-users.svg" alt="" />
          Employees
        </NuxtLink>
        <NuxtLink :to="{ name: 'companies-id-teams' }" class="nav-link" exact-active-class="nav-link active">
          <img src="/assets/svgs/ic-briefcase.svg" alt="" />
          My Teams
        </NuxtLink>
        <NuxtLink :to="{ name: 'companies-id-roles' }" class="nav-link" exact-active-class="nav-link active">
