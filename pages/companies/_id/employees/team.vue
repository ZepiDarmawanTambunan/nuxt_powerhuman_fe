            ...
            <form>
                <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 xl:gap-10 lg:gap-3 mb-[50px]">
                    ...
                    <div class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0" v-else
                        ...
                        <input type="radio" name="team_id" :id="'team_'+team.id" :checked="team.id == team_id" :value="team.id" @click="updateTeamId"
    ...
    methods: {
        ...
        async createEmployee() {
            try {
                ...
                formData.append('age', this.$store.state.employee.age);
                formData.append('phone', this.$store.state.employee.phone);
                formData.append('role_id', this.$store.state.employee.role_id);
                formData.append('team_id', this.$store.state.employee.team_id);
                if (this.$store.state.employee.photo) {
                  formData.append('photo', this.$store.state.employee.photo);
                }
                ...
                this.$store.commit('employee/updateRoleResponsibilities', '')
